...
fn vmo_summary_present(slots: &[u64]) -> bool {
...
fn print_vmo_summary(slots: &[u64]) {
    crate::kprintln!(
        "kernel: vmo info smoke (vmo_present={}, vmo_failure_step={}, vmo_info={}, vmo_info_kind={}, vmo_info_backing_scope={}, vmo_info_flags={}, vmo_info_size={}, vmo_boot_code_info={}, vmo_boot_code_kind={}, vmo_boot_code_backing_scope={}, vmo_boot_code_flags={}, vmo_boot_code_size_nonzero={}, vmo_boot_code_size={})",
        slots[SLOT_VMO_PRESENT],
        slots[SLOT_VMO_FAILURE_STEP],
        slots[SLOT_VMO_INFO] as i64,
        slots[SLOT_VMO_INFO_KIND],
        slots[SLOT_VMO_INFO_BACKING_SCOPE],
        slots[SLOT_VMO_INFO_FLAGS],
        slots[SLOT_VMO_INFO_SIZE],
        slots[SLOT_VMO_BOOT_CODE_INFO] as i64,
        slots[SLOT_VMO_BOOT_CODE_KIND],
        slots[SLOT_VMO_BOOT_CODE_BACKING_SCOPE],
        slots[SLOT_VMO_BOOT_CODE_FLAGS],
        slots[SLOT_VMO_BOOT_CODE_SIZE_NONZERO],
        slots[SLOT_VMO_BOOT_CODE_SIZE],
    );
}
...
pub fn on_breakpoint(frame: *const crate::arch::int80::TrapFrame) -> ! {
    ...
    crate::kprintln!(
        ...
        slots[SLOT_VMO_BOOT_CODE_BACKING_SCOPE],
        slots[SLOT_VMO_BOOT_CODE_FLAGS],
        slots[SLOT_VMO_BOOT_CODE_SIZE_NONZERO] as i64,
        slots[SLOT_VMO_BOOT_CODE_SIZE],
