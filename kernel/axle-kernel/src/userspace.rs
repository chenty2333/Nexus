...
const SLOT_MAX: usize = SLOT_SOCKET_DUP_WAIT_PEER_CLOSED_OBS;
...
fn try_load_user_program_from_qemu_loader() -> Option<u64> {
    let blob = qemu_loader_user_runner_blob()?;
