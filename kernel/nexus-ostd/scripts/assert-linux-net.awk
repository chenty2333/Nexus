...
BEGIN {
    ...
    expect("NETWORK_COMPANION STALE_GENERATION PASS kind=socket scope=110 effect=2 presented=1 current=2 result=StaleSocketGeneration projection_before=38368b66404dd410 projection_after=38368b66404dd410 full_projection_unchanged=true mutation=false bounded=true single_cpu=true")
    expect("NETWORK_COMPANION STALE_GENERATION PASS kind=source scope=111 effect=3 presented=1 current=2 result=StaleSourceGeneration projection_before=7a2feed78a0ed58d projection_after=7a2feed78a0ed58d full_projection_unchanged=true mutation=false bounded=true single_cpu=true")
