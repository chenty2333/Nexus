...
BEGIN {
    ...
    expect("NETWORK_LIFECYCLE StaleReplay sender=1051 old_binding=1 current_binding=2 result=StaleBinding projection_before=44da0947932b651e projection_after=44da0947932b651e full_projection_unchanged=true mutation=false")
    ...
    expect("NETWORK_COMPANION STALE_GENERATION PASS kind=socket scope=110 effect=2 presented=1 current=2 result=StaleSocketGeneration projection_before=c46bba73af761ee0 projection_after=c46bba73af761ee0 full_projection_unchanged=true mutation=false bounded=true single_cpu=true")
    expect("NETWORK_COMPANION STALE_GENERATION PASS kind=source scope=111 effect=3 presented=1 current=2 result=StaleSourceGeneration projection_before=1d23525587c82961 projection_after=1d23525587c82961 full_projection_unchanged=true mutation=false bounded=true single_cpu=true")
