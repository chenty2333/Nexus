...
BEGIN {
    ...
    expect("NETWORK_LIFECYCLE StaleReplay sender=1051 old_binding=1 current_binding=2 result=StaleBinding projection_before=30fb173a30270f9d projection_after=30fb173a30270f9d full_projection_unchanged=true mutation=false")
    ...
    expect("NETWORK_COMPANION STALE_GENERATION PASS kind=socket scope=110 effect=2 presented=1 current=2 result=StaleSocketGeneration projection_before=3ed3010de3a8e0be projection_after=3ed3010de3a8e0be full_projection_unchanged=true mutation=false bounded=true single_cpu=true")
    expect("NETWORK_COMPANION STALE_GENERATION PASS kind=source scope=111 effect=3 presented=1 current=2 result=StaleSourceGeneration projection_before=cda7582910726445 projection_after=cda7582910726445 full_projection_unchanged=true mutation=false bounded=true single_cpu=true")
