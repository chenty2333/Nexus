...
const DYNAMIC_INTERPRETER_ELF: &[u8] = include_bytes!("../guest/linux-dynamic-runtime-interp.elf");
const PERSONALITY_V1_PROGRAM: &[u8] = include_bytes!("../guest/linux-dynamic-personality-v1.bin");
const PERSONALITY_V2_PROGRAM: &[u8] = include_bytes!("../guest/linux-dynamic-personality-v2.bin");
